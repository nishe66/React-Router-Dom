...
const Hero = () => {
  return (
    <section className='bg-[#F1F1F3] pb-8'>
     <div className='container font-be-vietnam-pro pt-20 pb-20 h-auto mx-auto '>
     ...
     <div className='flex items-center w-[60%] py-8  bg-[#FCFCFD] rounded-lg mx-auto justify-evenly'>
